...
export default function Footer() {
  return (
    <div style={{ alignItems:"center",justifyContent:"center",textAlign:"center",width:"100%",height:"130px",marginTop:"510px",position:"fixed",borderTop:"2px solid gray", backgroundColor:" rgba(44, 37, 105, 0.603)", color:"white",}}>
